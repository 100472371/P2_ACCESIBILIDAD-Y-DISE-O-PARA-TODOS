              ...
              Container(
                ...
                child: Stack(
                  children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Semantics(
                                  label: 'Icono parar cambiar el idioma',
                                  child: InkWell(
                    ...
                    Align(
                      alignment: const AlignmentDirectional(-1.02, -0.46),
                      child: Semantics(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Semantics(
                                    label:
                                        'Calendario con los diferentres dias de cada mes',
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'f4inb1wb' /* Instalación deportiva */,
                                                                ),
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Semantics(
                                                            label:
                                                                'Imagen de diferentes pelotas de deportes',
                                                            child: ClipRRect(
                                                              borderRadius:
                                                                  BorderRadius
                                                                      .circular(
                                                              ...
                                                              child:
                                                                  Image.network(
                                                                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTO56URSmSk838PF7atVtKbaJZcGDFZCI6-bw&s',
                                                                width: 200.0,
                                                                height: 200.0,
                                                                fit: BoxFit
                                                                    .cover,
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'mnyg18wv' /* Instalación deportiva */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .headlineSmall
