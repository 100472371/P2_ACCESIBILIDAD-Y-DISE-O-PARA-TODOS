...
import 'activities_a_l_l_model.dart';
export 'activities_a_l_l_model.dart';

class ActivitiesALLWidget extends StatefulWidget {
  const ActivitiesALLWidget({super.key});

  @override
  State<ActivitiesALLWidget> createState() => _ActivitiesALLWidgetState();
}

class _ActivitiesALLWidgetState extends State<ActivitiesALLWidget> {
  late ActivitiesALLModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActivitiesALLModel());
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'vdgdf8u1' /* Actividades deportivas */,
                                          ),
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'ivv90ued' /* Elige tu deporte favorito y ad... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                ...
                                children: [
                                  Stack(
                                    children: [
                                      Semantics(
                                        label:
                                            'Imagen que representa el pabellón a alquilar.',
                                        child: ClipRRect(
                                          borderRadius:
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'a53bnv9i' /* Alquiler del pabellón para act... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                  ...
                                  Semantics(
                                    label: 'Botón para iniciar la compra.',
                                ...
                                children: [
                                  Stack(
                                    children: [
                                      Semantics(
                                        label:
                                            'Imagen que representa el campo de fútbol-7  a alquilar.',
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(12.0),
                                          child: Image.network(
                                            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfhxQ0hCkk_dBaqaF2F7sQHBDFLicUtwTrXg&s',
                                            width: MediaQuery.sizeOf(context)
                                                    .width *
                                                1.0,
                                            height: 200.0,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'hwetl0eq' /* Alquiler de la pista de césped... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                ...
                                children: [
                                      ...
                                      Semantics(
                                        ...
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(12.0),
                                          child: Image.network(
                                            'https://news.mondoiberica.com.es/wp-content/uploads/2018/02/IMG-20180201-WA0002_ret.jpg',
                                            width: MediaQuery.sizeOf(context)
                                                    .width *
                                                1.0,
                                            height: 200.0,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'a4obal3m' /* Alquiler de la pista de césped... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                ...
                                children: [
                                  Stack(
                                    children: [
                                      Semantics(
                                        label:
                                            'Imagen que representa la pista de padel  a alquilar.',
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(12.0),
                                          child: Image.network(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '5zu6o9sn' /* Alquiler de la pista de pádel(... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                ...
                                children: [
                                  Stack(
                                    children: [
                                      Semantics(
                                        label:
                                            'Imagen que representa la actividad de natación a alquilar.',
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(12.0),
                                          child: Image.network(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '9jv9ierg' /* Permiso para nadar en la pisci... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
