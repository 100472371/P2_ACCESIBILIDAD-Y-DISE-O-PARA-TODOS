...
import 'activity3_model.dart';
export 'activity3_model.dart';

class Activity3Widget extends StatefulWidget {
  const Activity3Widget({super.key});

  @override
  State<Activity3Widget> createState() => _Activity3WidgetState();
}

class _Activity3WidgetState extends State<Activity3Widget> {
  late Activity3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Activity3Model());
                ...
                Container(
                  ...
                  child: Stack(
                    children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'up4kke96' /* Actividades deportivas */,
                                        ),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'a2fxxcpy' /* Elige tu deporte favorito y ad... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                      ...
                      Align(
                        alignment: const AlignmentDirectional(-1.04, -0.41),
                        child: Semantics(
                                ...
                                children: [
                                  Stack(
                                    children: [
                                      Semantics(
                                        label:
                                            'Imagen que representa un campo de futbol 11',
                                        child: ClipRRect(
                                          borderRadius:
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'l7xzgtuh' /* Alquiler de la pista de césped... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
