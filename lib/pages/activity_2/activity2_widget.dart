...
import 'activity2_model.dart';
export 'activity2_model.dart';

class Activity2Widget extends StatefulWidget {
  const Activity2Widget({super.key});

  @override
  State<Activity2Widget> createState() => _Activity2WidgetState();
}

class _Activity2WidgetState extends State<Activity2Widget> {
  late Activity2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Activity2Model());
                ...
                Container(
                  ...
                  child: Stack(
                    children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'f6ptdnc8' /* Actividades deportivas */,
                                        ),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'y86pef9j' /* Elige tu deporte favorito y ad... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                      ...
                      Align(
                        alignment: const AlignmentDirectional(-1.01, -0.43),
                        child: Semantics(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Stack(
                                    children: [
                                      Semantics(
                                        label: 'Imagen de un campo de fútbol 7',
                                        child: ClipRRect(
                                          borderRadius:
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '6m24hzdq' /* Alquiler de la pista de césped... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
